...
| 音声合成Box| <details><summary>高品質な音声合成デバイス</summary><sub>KDDI総合研究所製音声合成ソフトN2を搭載したBox型音声合成デバイス<br />今回は2種類のBoxを用意、それぞれ別の声質を出すようにしました。</sub></details>| [n2](https://github.com/kdg-hacks/kdg-hacks-examples/tree/master/n2) | TODO| [KDDI総合研究所N2](https://www.kddi-research.jp/products/n2.html)|
